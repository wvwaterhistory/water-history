...
const EqualitySection = ({ showMedia }) => (
      ...
      <div className="col-sm-10 col-sm-offset-1 top-space">
        ...
        <div className="row">
          <div className="col-sm-4">
            ...
            <MediaLink onClick={showMedia.bind(null, "audio", 6)} mediaTitle="Being Poor During A Crisis" icon="watts" />
          </div>
          <div className="col-sm-4">
            ...
            <MediaLink onClick={showMedia.bind(null, "audio", 5)} mediaTitle="Race and Class Matter" icon="good" />
          </div>
          <div className="col-sm-4">
            ...
            <MediaLink onClick={showMedia.bind(null, "audio", 7)} mediaTitle="Bad Well Water, Bad City Water" icon="DJ" />
          </div>
        </div>
