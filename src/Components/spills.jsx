      ...
      <div className="col-sm-10 col-sm-offset-1">
        ...
        <div className="row top-space">
          <div className="col-sm-4">
            ...
            <MediaLink onClick={showMedia.bind(null, "audio", 3)} mediaTitle="A Life of Poisoned Water" icon="DJ" />
            <MediaLink onClick={showMedia.bind(null, "audio", 4)} mediaTitle="Fighting for Clean Water in Prenter, WV" icon="lambert" />
          </div>
          <div className="col-sm-4">
            ...
            <MediaLink onClick={showMedia.bind(null, "video", 0)} mediaTitle="Chemical Valley Girl" icon="good" />
          </div>
          <div className="col-sm-4">
            ...
            <MediaLink onClick={showMedia.bind(null, "audio", 2)} mediaTitle="An Expected Spill" icon="stottlemyer" />
          </div>
        </div>
        <div className="row">
          <blockquote className="bq-header">
